...
const localStorageAtoms = {
  ...
  speechToText: atomWithLocalStorage('speechToText', false), // 🆕 Deshabilitado por defecto
  ...
  textToSpeech: atomWithLocalStorage('textToSpeech', false), // 🆕 Deshabilitado por defecto
