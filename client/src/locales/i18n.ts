...
i18n
  ...
  .init({
    lng: 'es', // 🆕 FORZAR ESPAÑOL SIEMPRE
    fallbackLng: {
      'zh-TW': ['zh-Hant', 'es'],
      'zh-HK': ['zh-Hant', 'es'],
      zh: ['zh-Hans', 'es'],
      default: ['es'], // 🆕 Fallback a español en lugar de inglés
    },
    ...
    // 🆕 Configuraciones para deshabilitar detección automática
    detection: {
      order: [], // Vacío para evitar detección automática
      caches: ['localStorage'], // Solo guardar en localStorage
    },
  });
