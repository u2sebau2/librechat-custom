...
export default function useStepHandler({
  ...
  const updateContent = (
    ...
    } else if (contentType === ContentTypes.CITATION && 'citation' in contentPart) {
      // Handle Bedrock citation blocks
      const citation = contentPart.citation;
      console.log('[BEDROCK-CITATIONS-V4] Processing citation in SSE:', citation);
      
      updatedContent[index] = {
        type: ContentTypes.CITATION,
        citation: citation,
      };
